...
namespace DiceGame
{
    public partial class Form3 : Form
    {
        ...
        private void Form3_Load(object sender, EventArgs e)
        {
            ...
            // Στο δύσκολο επίπεδο(2) η αξία της έδρας διπλασιάστηκε
            firstClickValue = (startIndex + 1) * 2;
        }
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            // Στο δύσκολο επίπεδο(2) η αξία κάθε έδρας διπλασιάστηκε
            clickValue = (index + 1) * 2;
        ...
        {
            // Στο δύσκολο επίπεδο(2) η ταχύτητα διπλασιάστηκε
            if (moveRight)
            {
                pictureBox1.Left += 10;
            }
